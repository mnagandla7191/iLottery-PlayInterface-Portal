...
Library    DataDriver    ../../datafile_Portal.xls    sheet_name=Wagering_DDT
Test Template  testcase for wagering with all using Quickpick
...
***Keywords***
testcase for wagering with all using Quickpick
    [Arguments]    ${i}
